...
const mockAiResult = {
  ...
  captions_json: JSON.stringify({
    captions: [
      { style: 'ให้ความรู้', text: '🌱 ต้นกล้าข้าวในภาพนี้อยู่ในระยะกล้าอายุประมาณ 15-20 วัน\n\nสังเกตจากใบเขียวเข้ม แข็งแรง แสดงถึงการได้รับธาตุอาหารที่เพียงพอ พื้นที่แปลงนามีน้ำขังระดับพอดี ไม่ล้นคันนา เป็นสัญญาณของการเตรียมพื้นที่ที่ดี\n\n⚠️ ข้อควรระวัง:\n1️⃣ เพลี้ยกระโดดสีน้ำตาลที่จะเริ่มระบาดช่วงนี้\n2️⃣ โรคใบไหม้ในช่วงที่มีความชื้นสูง' },
      { style: 'เล่าสั้นๆ', text: '🌾 ต้นกล้าข้าวของเราพร้อมลงแปลงแล้วจ้า!\n\nเขียว สด แข็งแรง ฤดูทำนาปีนี้ต้องดีแน่นอน ติดตามไปด้วยกันนะครับ #ทำนา #ชาวนา' },
      { style: 'ราชการอ่านง่าย', text: '🏛️ รายงานความก้าวหน้าการเตรียมแปลงนา\n\nสถานะ: ต้นกล้าอายุ 15-20 วัน มีความสมบูรณ์พร้อมสำหรับการปักดำ\n\nกำหนดการ:\n- เริ่มปักดำ: 15 พฤษภาคม 2569\n- ติดตามผล: ทุก 15 วัน' },
    ],
    hashtags: ['#เกษตรไทย', '#ข้าวไทย', '#ทำนา', '#ฤดูนาปี', '#เกษตรอินทรีย์', '#ชาวนาไทย', '#ต้นกล้าข้าว'],
  }),
  caption: '🌱 ต้นกล้าข้าวในภาพนี้อยู่ในระยะกล้าอายุประมาณ 15-20 วัน\n\nสังเกตจากใบเขียวเข้ม แข็งแรง แสดงถึงการได้รับธาตุอาหารที่เพียงพอ',
  hashtags: '#เกษตรไทย #ข้าวไทย #ทำนา #ฤดูนาปี #เกษตรอินทรีย์ #ชาวนาไทย #ต้นกล้าข้าว',
