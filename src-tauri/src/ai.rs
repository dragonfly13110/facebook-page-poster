...
pub fn vision_prompt() -> &'static str {
  "วิเคราะห์ภาพนี้อย่างละเอียด แล้วสร้างข้อความโพสต์ Facebook ภาษาไทยสำหรับเพจเกษตร\n\
   ...
   \n\
   กฎการจัดรูปแบบ (Formatting Rules - สำคัญมาก):\n\
   1. **ต้องมีการขึ้นบรรทัดใหม่ (Newline) ระหว่างย่อหน้าเสมอ** เพื่อให้อ่านง่าย\n\
   2. **ถ้ามีรายการ (List) หรือการลำดับหัวข้อ ต้องขึ้นบรรทัดใหม่ทุกรายการ** ห้ามเขียนต่อกันเป็นพรืด\n\
   3. ตัวอย่างการจัดรูปแบบที่ถูกต้อง:\n\
      ประโยคเปิดหัวข้อที่น่าสนใจ...\n\n\
      1️⃣ รายการที่หนึ่ง...\n\
      2️⃣ รายการที่สอง...\n\n\
      สรุปท้ายโพสต์...\n\
   \n\
   ...
   - ถ้าต้องการลำดับหัวข้อ ให้ใช้อีโมจิตัวเลข เช่น 1️⃣ 2️⃣ 3️⃣ (เว้นวรรคหลังอีโมจิด้วย)\n\
   ...
   \n\
   ให้ตอบกลับในรูปแบบ JSON เท่านั้น (ตรวจสอบว่าใน field 'text' มี \\n สำหรับการขึ้นบรรทัดใหม่):\n\
